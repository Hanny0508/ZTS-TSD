...
Usage:
nohup python scripts/stego2bit.py -o zgls/imdb_s3.csv --force --mode cover --cover zgls_data/imdb.csv  --n-cover 16000 --threshold 0.002 --max-bpw 5 --n-rows 5 zgls/imdb_s2_c16000_t_b.csv > log/stego2bit.log 2>&1 &
