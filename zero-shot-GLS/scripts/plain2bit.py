...
Usage:
    ...
    python scripts/plain2bit.py -o imdb_s1.csv --n-rows 16000 zgls_data/imdb.csv
    nohup python scripts/plain2bit.py -o zgls/imdb_s1.csv -n 16000 zgls_data/imdb.csv > log/plain2bit.log 2>&1 &
"""
import argparse
import csv
import logging
